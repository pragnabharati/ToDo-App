...
test("<TodoList /> #display", async () => {
    ...
    expect(
        ...
        '<li class="list-group-item">a<button class="float-right btn btn-danger btm-sm" style="margin-left: 10px;">Complete</button></li>'
    );
    expect(
        list
        .find("li")
        ...
        listfind("button").forEach(b => b.simulate("click"));
